...
class QueryHistory(models.Model):
  ...
  def get_query_server_config(self, access_token: dict = None):
    from beeswax.server.dbms import get_query_server_config

    query_server = get_query_server_config(QueryHistory.get_type_name(self.query_type), access_token=access_token)
    query_server.update({
